	...
	private ConnectionManager() {
		try {
			...
			mongoClient = MongoClients.create(
					"mongodb+srv://user:ebticspl@acmeaircluster.ammld.mongodb.net/acmeair?retryWrites=true&w=majority");
			db = mongoClient.getDatabase("acmeair");
			logger.info("#### Mongo DB Server connected ####");
		}
		catch(Exception e){
